...
<body>
<h1 style= "color:green;"><em><span style="border-bottom: 2px solid green;">맛.zip</span></em></h1>
...
<h3 style= "color:green;"><em id="id">${id}님</em></h3>
...
<table>
	<tr>
		...
		<button style="background:gray;"><h4>자유게시판</h4></button></a></td>
		<td class="top0"><a href="owner_login">
